...
namespace venta_de_dispositivos
{
    public partial class flaptop : Form
    {
        ...
        private void flaptop_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                string consulta = "select*from producto_laptop";
        ...
        private void btbbuscar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string mySelectQuery = "SELECT * From producto_laptop Where id_producto=" + txtbuscar.Text + "";
        ...
        private void btbcomprar_Click(object sender, EventArgs e)
        {
